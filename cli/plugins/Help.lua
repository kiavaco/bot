...
if ((matches[1]:lower() == 'help' ) or (matches[1]:lower() == 'راهنما' )) and is_sudo(msg) then
...
---------------------------------------
if ((matches[1]:lower() == 'helplock' ) or (matches[1]:lower() == 'راهنمای قفلی' )) and is_sudo(msg) then
local helpen = _help and _help.helpen
local helpfa = _help and _help.helpfa
...
---------------------------------------
 if ((matches[1]:lower() == 'helplockpro' ) or (matches[1]:lower() == 'راهنمای قفلی پیشرفته' )) and is_sudo(msg) then
local helpen = _help and _help.helpen
local helpfa = _help and _help.helpfa
...
---------------------------------------
if ((matches[1]:lower() == 'helpmod' ) or (matches[1]:lower() == 'راهنمای مدیریتی' )) and is_sudo(msg) then
local helpen = _help and _help.helpen
local helpfa = _help and _help.helpfa
...
---------------------------------------
if ((matches[1]:lower() == 'helpfun' ) or (matches[1]:lower() == 'راهنمای سرگرمی' )) and is_sudo(msg) then
local helpen = _help and _help.helpen
local helpfa = _help and _help.helpfa
